...
Check version number in setup.json and aiida_rhino_zfs/__init__.py and make sure
they match.
"""
...
import aiida_rhino_zfs  # pylint: disable=wrong-import-position
version = aiida_rhino_zfs.__version__
